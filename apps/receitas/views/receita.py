...
def index(request):
    ...
    # Paginação do site
    paginator = Paginator(receitas,3) # Paginator(Dado,numero de dados por pagina)
...
def cria_receita(request):
    if request.method == 'POST':
        ...
        foto_receita = request.FILES['foto_receita'] # para imagem
        ...
        return render(request, 'receitas/cria_receitas.html')
